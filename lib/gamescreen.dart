...
class _GamePageState extends State<GamePage> {
  ...
  void initState() {
    ...
    //Random position generator for computer
  ...
  //Check Game is end or draw . If end return the winner
  ...
  //Popup dialouge when changing difficulty
  ...
  //Popup dialouge when finish the game
  ...
  //Popup dialouge when try to exit
  Object goBack() async {
  ...
  //Find best move for machine according to the diffculty level
  ...
  //Calculate best position for computer when 'X' postion is given
  ...
  //Calculate best position for computer when 'O' postion is given
  ...
  //Calculate move for computer according to each diffculty level
